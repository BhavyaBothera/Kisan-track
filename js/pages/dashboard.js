...
// Purpose: Main logic for dashboard.js
// Page: Multiple
...
const DashboardModule = (function () {
  ...
  function updateWelcomeBanner(farmer) {
    ...
    greetEl.innerHTML = `${greetEn}, ${firstName} ${emoji} <span style="display:block; font-size:16px; opacity:0.8;">${greetHi}</span>`;
    ...
    if (sbAvatar) sbAvatar.textContent = firstName[0].toUpperCase();
  }
